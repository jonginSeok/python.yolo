...
for split, files in splits_data.items():
    for img_file, label_file in files:
        shutil.copy(os.path.join(image_dir, img_file), os.path.join(data_path, split, 'images', img_file))
        shutil.copy(os.path.join(label_dir, label_file), os.path.join(data_path, split, 'labels', label_file))
