...
data_path = "media/datasets/0" # 에러 방지
...
# 모델 저장 (학습 루프 끝난 후)
save_path = "media/datasets/0/cnn_with_size_letterbox.pth"
torch.save(model.state_dict(), save_path)
print(f"Model saved to {save_path}")


# 모델 다시 불러오기
# save_path = "/content/drive/MyDrive/Python_AI/carrot_cnn_with_size_letterbox.pth"
# model = CNNWithSize().to(DEVICE)
